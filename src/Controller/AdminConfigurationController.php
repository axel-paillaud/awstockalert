...
namespace Axelweb\AwStockAlert\Controller;
...
class AdminConfigurationController extends FrameworkBundleAdminController
{
    ...
    {
        $generalFormDataHandler = $this->get('axelweb.awstockalert.form.general_form_data_handler');
        ...
        if ($generalForm->isSubmitted() && $generalForm->isValid()) {
            ...
            if (empty($errors)) {
                ...
                return $this->redirectToRoute('awstockalert_form_configuration');
            }

            $this->flashErrors($errors);
        }

        return $this->render('@Modules/awstockalert/views/templates/admin/form.html.twig', [
